...
void	VID_Init (unsigned char *palette)
{
   ...
   // (nozzle software) -> setup splash screen before loading main window
   // (nozzle software) -> default path (./nozzle/splash)
   // (nozzle software) -> instead, load a demo (smarter than other options...)
...
// create the main window
		x_win = XCreateWindow(	x_disp,
			...
			attribmask,
			&attribs );
		XStoreName( x_disp,x_win,"WaspSrc");
